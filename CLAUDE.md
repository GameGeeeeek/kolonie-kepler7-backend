...
- **Frontend hat teils eigene Kopien von Backend-Konstanten** (z.B. `ALLIANCE_STRUCTURE_COSTS`, `ALLIANCE_EXPANSION_BONUSES` zur Validierung von Allianz-Freischaltungen gegen echte Beiträge). Bei Kostenänderungen im Frontend **immer** die Backend-Kopie mitpflegen, sonst lehnt der Server legitime Aktionen ab oder lässt zu wenig-Beiträge durch.
